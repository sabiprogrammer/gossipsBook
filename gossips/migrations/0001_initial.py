# Generated by Django 3.0.8 on 2020-12-19 12:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='What is the title of your gossip?', max_length=65, unique=True, verbose_name='Title')),
                ...
                ('false', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='false', to=settings.AUTH_USER_MODEL)),
                ('q_tags', models.ManyToManyField(blank=True, to='gossips.Tags')),
                ('true', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='true', to=settings.AUTH_USER_MODEL)),
            ],
            options={
